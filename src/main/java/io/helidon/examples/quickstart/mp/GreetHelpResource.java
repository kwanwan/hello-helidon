...
public class GreetHelpResource {
    ...
    public String getAllGreetings(){
        ...
        return Arrays.toString(List.of("Hello and Welcome to Verrazzano DevOps Demo for Oracle Cloud World on Verrazzano","Привет","Hola","Hallo","Ciao","Nǐ hǎo", "Marhaba","Olá").toArray());
    }
}
